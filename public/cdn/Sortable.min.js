...
!(function (t, e) {
  ...
  function k(t, e, n, o) {
    if (t) {
      ...
      do {
        if (
          (null != e && (">" === e[0] ? t.parentNode === n && d(t, e) : d(t, e))) ||
          (o && t === n)
        )
          return t;
        if (t === n) break;
  ...
  function B(t, e) {
    for (
      ...
      n && (n === Mt.ghost || "none" === R(n, "display") || (e && !d(n, e)));
  ...
  function C() {
    ...
    return {
      ...
      removeAnimationState: function (t) {
        m.splice(
          (function (t, e) {
            for (var n in t) for (var o in e) if (e[o] === t[n][o]) return Number(n);
            return -1;
          })(m, { target: t }),
          1
        );
          ...
          g && ((d.top -= g.f), (d.left -= g.e)),
            ...
            ((Y(c, d, "bottom", "top") ||
              ...
              (c.thisAnimationDuration &&
                y(h, d) &&
                !y(u, d) &&
                (p.top - d.top) / (p.left - d.left) == (u.top - d.top) / (u.left - d.left) &&
                ((e = p),
                (n = h),
                (o = f),
                (i = this.options),
              ...
              s &&
                ...
                (c.animationResetTimer = setTimeout(
                  ...
                  }.bind({ animationStates: m, i: Number(l) }),
                  s
                )),
                (c.thisAnimationDuration = s)));
        }
        clearTimeout(v),
          r
    ...
    O = {
      ...
      pluginEvent: function (t, e, n) {
        ...
        for (var i in T)
          e[T[i].pluginName] &&
            (e[T[i].pluginName][o] &&
              (this.eventCanceled = !!e[T[i].pluginName][o](I({ sortable: e }, n))),
            e.options[T[i].pluginName] &&
              e[T[i].pluginName][t] &&
              (this.eventCanceled =
                this.eventCanceled || !!e[T[i].pluginName][t](I({ sortable: e }, n))));
      },
      ...
      modifyOption: function (t, e, n) {
        ...
        for (var i in T)
          t[T[i].pluginName] &&
            T[i].optionListeners &&
            "function" == typeof T[i].optionListeners[e] &&
            (o = T[i].optionListeners[e].call(t[T[i].pluginName], n));
        return o;
      },
    };
  function N(t) {
  ...
  function Mt(t, e) {
    ...
    (this.nativeDraggable = !e.forceFallback && Dt),
      ...
      e.supportPointer
        ...
        : (u(t, "mousedown", this._onTapStart), u(t, "touchstart", this._onTapStart)),
  ...
  (Mt.prototype = {
    ...
    _getDirection: function (t, e) {
      return "function" == typeof this.options.direction
        ? this.options.direction.call(this, t, e, W)
        ...
        if (
          ...
          if ((($ = F(l)), (tt = F(l, t.draggable)), "function" == typeof c)) {
            if (c.call(this, e, l, this))
              return (
                K({ sortable: n, rootEl: s, name: "filter", targetEl: l, toEl: o, fromEl: o }),
                j("filter", n, { evt: e }),
            ...
            (c = c.split(",").some(function (t) {
              if ((t = k(s, t.trim(), o, !1)))
                return (
                  K({ sortable: n, rootEl: t, name: "filter", targetEl: l, fromEl: o, toEl: o }),
                  j("filter", n, { evt: e }),
                  !0
                );
            }))
    ...
    _prepareDragStart: function (t, e, n) {
      ...
      if (n && !W && n.parentNode === r)
        if (
          ...
          (V = n),
          (nt = a.group),
          (it = { target: (Mt.dragged = W), clientX: (e || t).clientX, clientY: (e || t).clientY }),
          (this._lastX = (e || t).clientX),
          (this._lastY = (e || t).clientY),
          (W.style["will-change"] = "all"),
          (o = function () {
            j("delayEnded", i, { evt: t }),
              Mt.eventCanceled
                ? i._onDrop()
                : (i._disableDelayedDragEvents(),
                  !c && i.nativeDraggable && (W.draggable = !0),
                  i._triggerDragStart(t, e),
                  K({ sortable: i, name: "choose", originalEvent: t }),
                  P(W, a.chosenClass, !0));
          }),
          ...
          c && this.nativeDraggable && ((this.options.touchStartThreshold = 4), (W.draggable = !0)),
          j("delayStart", this, { evt: t }),
          !a.delay || (a.delayOnTouchOnly && !e) || (this.nativeDraggable && (D || w)))
        )
          o();
        else {
    ...
    _triggerDragStart: function (t, e) {
      (e = e || ("touch" == t.pointerType ? t : null)),
        !this.nativeDraggable || e
          ...
          : (u(W, "dragend", this), u(U, "dragstart", this._onDragStart));
      try {
        document.selection
          ? Pt(function () {
    ...
    _dragStarted: function (t, e) {
      if (((dt = !1), U && W)) {
        j("dragStarted", this, { evt: e }), this.nativeDraggable && u(document, "dragover", Ot);
        var n = this.options;
        t || P(W, n.dragClass, !1),
          P(W, n.ghostClass, !0),
          (Mt.active = this),
    ...
    _emulateDragOver: function () {
      if (rt) {
        ...
        for (
          ...
          t && t.shadowRoot && (t = t.shadowRoot.elementFromPoint(rt.clientX, rt.clientY)) !== e;

        )
          e = t;
        if ((W.parentNode[L]._isOutsideThisEl(t), e))
          do {
            if (e[L]) {
              if (
                e[L]._onDragOver({
    ...
    _appendGhost: function () {
      if (!G) {
        ...
        if (yt) {
          for (
            ut = t;
            "static" === R(ut, "position") && "none" === R(ut, "transform") && ut !== document;

          )
            ut = ut.parentNode;
          ut !== document.body && ut !== document.documentElement
            ? (ut === document && (ut = M()), (e.top += ut.scrollTop), (e.left += ut.scrollLeft))
            : (ut = M()),
            (vt = v(ut));
        }
        P((G = W.cloneNode(!0)), n.ghostClass, !1),
          P(G, n.fallbackClass, !0),
          P(G, n.dragClass, !0),
          R(G, "transition", ""),
          R(G, "transform", ""),
          ...
          R(G, "height", e.height),
          R(G, "opacity", "0.8"),
          R(G, "position", yt ? "absolute" : "fixed"),
          R(G, "zIndex", "100000"),
        ...
        Mt.eventCanceled
          ...
          : (j("setupClone", this),
            Mt.eventCanceled ||
              ...
              (Z.style["will-change"] = ""),
              this._hideClone(),
              P(Z, this.options.chosenClass, !1),
              (Mt.clone = Z)),
            (n.cloneId = Pt(function () {
              j("clone", n),
                Mt.eventCanceled ||
                  (n.options.removeCloneOnHide || U.insertBefore(Z, W),
                  n._hideClone(),
                  K({ sortable: n, name: "clone" }));
            })),
            e || P(W, i.dragClass, !0),
            e
              ? ((ht = !0), (n._loopId = setInterval(n._emulateDragOver, 50)))
              : (r(document, "mouseup", n._onDrop),
                r(document, "touchend", n._onDrop),
                r(document, "touchcancel", n._onDrop),
                o && ((o.effectAllowed = "move"), i.setData && i.setData.call(n, o, W)),
                u(document, "drop", n),
                R(W, "transform", "translateZ(0)")),
            (dt = !0),
            (n._dragStartId = Pt(n._dragStarted.bind(n, e, t))),
            u(document, "selectstart", n),
            (at = !0),
            l && R(document.body, "user-select", "none"));
    },
        ...
        if (
          ...
          c &&
            ...
            (u
              ? d || (r = !U.contains(W))
              : ot === this ||
                ((this.lastPutMode = nt.checkPull(this, c, W, n)) && t.checkPut(this, c, W, n))))
        ) {
          if (
          ...
          if (r)
            return (
              ...
              this._hideClone(),
              O("revert"),
              Mt.eventCanceled || (q ? U.insertBefore(W, q) : U.appendChild(W)),
              A(!0)
            );
          ...
          if (
            ...
            if (g === W) return A(!1);
            if (
              (g && l === n.target && (s = g), s && (i = X(s)), !1 !== At(U, l, W, o, s, i, n, !!s))
            )
              return M(), l.appendChild(W), (z = l), N(), A(!0);
            ...
            if (
              (lt !== s && ((m = i[D]), (pt = !1), (gt = (!w && e.invertSwap) || y)),
              0 !==
                (v = (function (t, e, n, o, i, r, a) {
                  var l = X(e),
                  ...
                  if (!r)
                    if (a && ct < c * o) {
                      if (
                        (!pt && (1 === st ? u + (c * i) / 2 < s : s < d - (c * i) / 2) && (pt = !0),
                        pt)
                      )
                        h = !0;
                      else if (1 === st ? s < u + ct : d - ct < s) return -st;
                    } else if (u + (c * (1 - o)) / 2 < s && s < d - (c * (1 - o)) / 2)
                      return (function (t) {
                        return F(W) < F(t) ? 1 : -1;
                      })(e);
                  if ((h = h || r) && (s < u + (c * i) / 2 || d - (c * i) / 2 < s))
                    return u + c / 2 < s ? 1 : -1;
                  return 0;
                })(
                  n,
              ...
              for (
                var _ = F(W);
                (_ -= v), (b = z.children[_]) && ("none" === R(b, "display") || b === G);
            ...
            if (!1 !== x)
              return (
                ...
                setTimeout(It, 30),
                M(),
                T && !C ? l.appendChild(W) : s.parentNode.insertBefore(W, T ? C : s),
                E && H(E, 0, S - E.scrollTop),
                (z = W.parentNode),
                void 0 === m || gt || (ct = Math.abs(m - X(s)[D])),
                N(),
                A(!0)
              );
          }
      ...
      function A(t) {
        return (
          ...
          t &&
            ...
            f !== h &&
              (P(W, ot ? ot.options.ghostClass : c.options.ghostClass, !1), P(W, e.ghostClass, !0)),
            ot !== f && f !== Mt.active ? (ot = f) : f === Mt.active && ot && (ot = null),
          ...
          ((s === W && !W.animated) || (s === l && !s.animated)) && (lt = null),
          e.dragoverBubble ||
            n.rootEl ||
            s === document ||
            (W.parentNode[L]._isOutsideThisEl(n.target), t || xt(n)),
    ...
    _offMoveEvents: function () {
      r(document, "mousemove", this._onTouchMove),
        ...
        r(document, "dragover", xt),
        r(document, "mousemove", xt),
        r(document, "touchmove", xt);
    },
    ...
    _onDrop: function (t) {
      ...
      (J = F(W)),
        ...
        Mt.eventCanceled ||
          ...
          this.nativeDraggable && (r(document, "drop", this), r(e, "dragstart", this._onDragStart)),
          this._offMoveEvents(),
          this._offUpEvents(),
          l && R(document.body, "user-select", ""),
          t &&
            (at && (t.cancelable && t.preventDefault(), n.dropBubble || t.stopPropagation()),
            G && G.parentNode && G.parentNode.removeChild(G),
            (U === z || (ot && "clone" !== ot.lastPutMode)) &&
              Z &&
              Z.parentNode &&
            ...
            W &&
              ...
              Nt(W),
              (W.style["will-change"] = ""),
              at && !dt && P(W, ot ? ot.options.ghostClass : this.options.ghostClass, !1),
              P(W, this.options.chosenClass, !1),
              K({
                sortable: this,
                name: "unchoose",
                toEl: z,
              ...
              U !== z
                ? (0 <= J &&
                    (K({ rootEl: z, name: "add", toEl: z, fromEl: U, originalEvent: t }),
                    K({ sortable: this, name: "remove", toEl: z, originalEvent: t }),
                    K({ rootEl: z, name: "sort", toEl: z, fromEl: U, originalEvent: t }),
                    K({ sortable: this, name: "sort", toEl: z, originalEvent: t })),
                  ot && ot.save())
                : J !== $ &&
                  0 <= J &&
                  (K({ sortable: this, name: "update", toEl: z, originalEvent: t }),
                  K({ sortable: this, name: "sort", toEl: z, originalEvent: t })),
              Mt.active &&
                ((null != J && -1 !== J) || ((J = $), (et = tt)),
                K({ sortable: this, name: "end", toEl: z, originalEvent: t }),
                this.save())))),
        this._nulling();
    },
    _nulling: function () {
    ...
    _hideClone: function () {
      if (!Q) {
        ...
        R(Z, "display", "none"),
          this.options.removeCloneOnHide && Z.parentNode && Z.parentNode.removeChild(Z),
          (Q = !0);
      }
    },
    _showClone: function (t) {
      if ("clone" === t.lastPutMode) {
        if (Q) {
          ...
          U.contains(W) && !this.options.group.revertClone
            ? U.insertBefore(Z, W)
            : q
            ? U.insertBefore(Z, q)
            : U.appendChild(Z),
            this.options.group.revertClone && this._animate(W, Z),
            R(Z, "display", ""),
            (Q = !1);
        }
    ...
    qt = m(function (n, t, e, o) {
      if (t.scroll) {
        var i,
          ...
          s = !1;
        Yt !== e &&
          ((Yt = e), Wt(), (Xt = t.scroll), (i = t.scrollFn), !0 === Xt && (Xt = A(e, !0)));
        var c = 0,
          u = Xt;
        do {
          var d = u,
            ...
            d === l
              ? ((y =
                  ...
                  ("auto" === S.overflowX ||
                    ...
                    "visible" === S.overflowX)),
                b < E &&
                  ("auto" === S.overflowY || "scroll" === S.overflowY || "visible" === S.overflowY))
              : ((y = m < D && ("auto" === S.overflowX || "scroll" === S.overflowX)),
                b < E && ("auto" === S.overflowY || "scroll" === S.overflowY));
          var T =
              y &&
              (Math.abs(v - n.clientX) <= r && _ + m < D) - (Math.abs(g - n.clientX) <= r && !!_),
            x =
              w &&
              (Math.abs(p - n.clientY) <= r && C + b < E) - (Math.abs(f - n.clientY) <= r && !!C);
          if (!jt[c]) for (var O = 0; O <= c; O++) jt[O] || (jt[O] = {});
          (jt[c].vx == T && jt[c].vy == x && jt[c].el === d) ||
            ((jt[c].el = d),
            (jt[c].vx = T),
            (jt[c].vy = x),
            clearInterval(jt[c].pid),
            (0 == T && 0 == x) ||
              ((s = !0),
              (jt[c].pid = setInterval(
                function () {
                  o && 0 === this.layer && Mt.active._onTouchMove(Ht);
                  var t = jt[this.layer].vy ? jt[this.layer].vy * a : 0,
                    e = jt[this.layer].vx ? jt[this.layer].vx * a : 0;
                  ("function" == typeof i &&
                    "continue" !==
                      i.call(Mt.dragged.parentNode[L], e, t, n, Ht, jt[this.layer].el)) ||
          ...
          (t.prototype = {
            ...
            dragOverValid: function (t) {
              ...
              if (i.options.swap) {
                ...
                if (n && n !== a) {
                  var s = Ut;
                  (Ut = !1 !== o(n) ? (P(n, l.swapClass, !0), n) : null),
                    s && s !== Ut && P(s, l.swapClass, !1);
                }
                return r(), e(!0);
              }
            },
          ...
          (t.prototype = {
            ...
            setupClone: function (t) {
              ...
              if (this.isMultiDrag) {
                for (var n in ne)
                  oe.push(E(ne[n])),
                    (oe[n].sortableIndex = ne[n].sortableIndex),
                    (oe[n].draggable = !1),
                    (oe[n].style["will-change"] = ""),
                    P(oe[n], e.options.selectedClass, !1),
                    ne[n] === Jt && P(oe[n], e.options.chosenClass, !1);
            ...
            clone: function (t) {
              ...
              if (this.isMultiDrag)
                return !e.options.removeCloneOnHide && ne.length && $t === e
                  ? (le(!0, n), o("clone"), !0)
                  : void 0;
            },
            showClone: function (t) {
              var e = t.cloneNowShown,
                n = t.rootEl;
              if (this.isMultiDrag) {
                for (var o in (le(!1, n), oe)) R(oe[o], "display", "");
                return e(), !(ee = !1);
              }
            },
                ...
                for (var o in oe)
                  R(oe[o], "display", "none"),
                    e.options.removeCloneOnHide &&
                      oe[o].parentNode &&
                      oe[o].parentNode.removeChild(oe[o]);
                return n(), (ee = !0);
              }
            },
            ...
            dragStarted: function (t) {
              ...
              if (this.isMultiDrag) {
                if (e.options.sort && (e.captureAnimationState(), e.options.animation)) {
                  for (var n in ne) ne[n] !== Jt && R(ne[n], "position", "absolute");
                  var o = X(Jt, !1, !0, !0);
                  for (var i in ne) ne[i] !== Jt && S(ne[i], o);
                  ie = re = !0;
                }
                e.animateAll(function () {
                  if (((ie = re = !1), e.options.animation)) for (var t in ne) _(ne[t]);
                  e.options.sort && se();
                });
              }
            },
            ...
            revert: function (t) {
              ...
              if (1 < ne.length) {
                for (var r in ne)
                  o.addAnimationState({ target: ne[r], rect: re ? X(ne[r]) : i }),
                    _(ne[r]),
                    (ne[r].fromRect = i),
                    e.removeAnimationState(ne[r]);
                (re = !1),
                  (function (t, e) {
                    for (var n in ne) {
            ...
            dragOverCompleted: function (t) {
              ...
              if (o) {
                if (
                  (n && i._hideClone(),
                  (ie = !1),
                  l.animation && 1 < ne.length && (re || (!n && !i.options.sort && !a)))
                ) {
                  var s = X(Jt, !1, !0, !0);
                ...
                if (!n)
                  if ((re || se(), 1 < ne.length)) {
                    ...
                    if ((i._showClone(e), i.options.animation && !ee && u))
                      for (var d in oe)
                        i.addAnimationState({ target: oe[d], rect: te }),
                          (oe[d].fromRect = te),
                          (oe[d].thisAnimationDuration = null);
                  } else i._showClone(e);
              }
            },
              ...
              if (e) {
                ...
                if (!ae)
                  if (
                    ...
                    P(Jt, c.selectedClass, !~ne.indexOf(Jt)),
                    ~ne.indexOf(Jt))
                  )
                    ne.splice(ne.indexOf(Jt), 1),
                      (Qt = null),
                      N({ sortable: i, rootEl: n, name: "deselect", targetEl: Jt, originalEvt: e });
                  else {
                    if (
                      (ne.push(Jt),
                      N({ sortable: i, rootEl: n, name: "select", targetEl: Jt, originalEvt: e }),
                      (!c.multiDragKey || this.multiDragKeyDown) &&
                        e.shiftKey &&
                        Qt &&
                        i.el.contains(Qt))
                    ) {
                ...
                if (ae && this.isMultiDrag) {
                  if ((o[L].options.sort || o !== n) && 1 < ne.length) {
                    var g = X(Jt),
                      v = F(Jt, ":not(." + this.options.selectedClass + ")");
                    if (
                      (!ie && c.animation && (Jt.thisAnimationDuration = null),
                      ...
                      if (c.animation)
                        for (var m in ((Jt.fromRect = g), ne))
                          if (((ne[m].thisAnimationDuration = null), ne[m] !== Jt)) {
                            var b = re ? X(ne[m]) : g;
                            (ne[m].fromRect = b), s.addAnimationState({ target: ne[m], rect: b });
                          }
                      for (var y in (se(), ne))
            ...
            _deselectMultiDrag: function (t) {
              if (
                ...
                $t === this.sortable &&
                !(
                  (t && k(t.target, this.sortable.options.draggable, this.sortable.el, !1)) ||
                  (t && 0 !== t.button)
                )
              )
                for (; ne.length; ) {
            ...
            utils: {
              select: function (t) {
                ...
                e &&
                  e.options.multiDrag &&
                  !~ne.indexOf(t) &&
                  ($t && $t !== e && ($t.multiDrag._deselectMultiDrag(), ($t = e)),
              ...
              deselect: function (t) {
                ...
                e &&
                  e.options.multiDrag &&
                  ~n &&
                  (P(t, e.options.selectedClass, !1), ne.splice(n, 1));
              },
            },
            eventOptions: function () {
              var n = this,
              ...
              return (
                ne.forEach(function (t) {
                  var e;
                  o.push({ element: t, index: t.sortableIndex }),
                    (e =
                      re && t !== Jt
                        ? -1
                        : re
                        ...
                        : F(t)),
                    i.push({ element: t, index: e });
                }),
                { items: e(ne), clones: [].concat(oe), oldIndicies: o, newIndicies: i }
              );
            },
            optionListeners: {
