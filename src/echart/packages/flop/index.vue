  ...
  computed: {
    ...
    getItemStyle () {
      return Object.assign((() => {
        ...
        letterSpacing: this.setPx(this.option.letterSpacing),
        lineHeight: this.setPx(this.option.lineHeight),
    ...
    prefixStyle () {
      return {
        ...
        fontFamily: this.option.prefixFontFamily,
      };
    },
    suffixStyle () {
      return {
        ...
        fontFamily: this.option.suffixFontFamily,
      };
    },
  },
  props: {
