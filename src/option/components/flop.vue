    ...
    <el-collapse accordion>
      <el-collapse-item title="内容设置">
        ...
        <el-form-item label="字体家族">
          <avue-select v-model="main.activeOption.fontFamily"
        ...
        <el-form-item label="字间距">
          <avue-input-number v-model="main.activeOption.letterSpacing" :max="50"></avue-input-number>
        </el-form-item>
        <el-form-item label="行高">
          <avue-input-number v-model="main.activeOption.lineHeight" :max="200"></avue-input-number>
        </el-form-item>
        <el-form-item label="圆角">
          <avue-input-number v-model="main.activeOption.borderRadius" :max="100"></avue-input-number>
        </el-form-item>
      </el-collapse-item>
      <el-collapse-item title="前缀设置">
        ...
        <el-form-item label="字体粗细">
          <avue-select v-model="main.activeOption.prefixFontWeight"
                       :dic="dicOption.fontWeight">
          </avue-select>
        </el-form-item>
        <el-form-item label="字体家族">
          <avue-select v-model="main.activeOption.prefixFontFamily"
                       :dic="dicOption.fontFamily">
          </avue-select>
        </el-form-item>
      </el-collapse-item>
      <el-collapse-item title="后缀设置">
        ...
        <el-form-item label="字体家族">
          <avue-select v-model="main.activeOption.suffixFontFamily"
                       :dic="dicOption.fontFamily">
          </avue-select>
        </el-form-item>
      </el-collapse-item>
